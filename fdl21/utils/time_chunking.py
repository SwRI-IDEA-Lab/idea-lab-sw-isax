...
def time_chunking_optimized(
    mag_df,
    cols,
    cadence = timedelta(seconds=1), 
    chunk_size = timedelta(seconds=300),
    ...
    interp_time_seq = interp_time_seq.reshape(
        interp_time_seq.shape[0], interp_time_seq.shape[1], 1
    )
    ...
    if return_pandas:
        ...
        return dfs 
    return interp_mag_seq, interp_time_seq, chunk_filelist
