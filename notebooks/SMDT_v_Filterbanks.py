...
axes[0].plot(freq_spectrum,FR1_detrend*FR1_smooth,linestyle='dashed',label='Detrend*Smooth')
...
axes[1].plot(freq_spectrum,FR1_detrend*FR1_smooth,label='Detrend*Smooth')
...
axes[0].plot(freq_spectrum,FR2_smooth,linestyle='dotted',label='Smoothing')
axes[0].plot(freq_spectrum,FR2_detrend,linestyle='dotted',label='Detrending')
axes[0].plot(freq_spectrum,FR2_detrend*FR2_smooth,linestyle='dashed',label='Detrend*Smooth')
axes[0].set_xlabel("Frequency")
axes[0].set_title('Full Spectrum')
axes[1].plot(freq_spectrum,FR2_smooth,linestyle='dotted',label='Smoothing')
axes[1].plot(freq_spectrum,FR2_detrend,linestyle='dotted',label='Detrending')
axes[1].plot(freq_spectrum,FR2_detrend*FR2_smooth,label='Detrend*Smooth')
axes[1].set_xlim(0,100)
axes[1].set_xlabel("Frequency")
axes[1].set_title('Zoomed in')
axes[0].legend()
...
# axes[0].plot(freq_spectrum,FR1_smooth,linestyle='dotted',label='Smoothing')
# axes[0].plot(freq_spectrum,FR1_detrend,linestyle='dotted',label='Detrending')
axes[0].plot(freq_spectrum,FR1_detrend*FR1_smooth,linestyle='dashed',label='window1')
axes[0].plot(freq_spectrum,FR2_detrend*FR2_smooth,linestyle='dashed',label='window2')
axes[0].set_xlabel("Frequency")
axes[0].set_title('Full Spectrum')
# axes[1].plot(freq_spectrum,FR1_smooth,linestyle='dotted',label='Smoothing')
# axes[1].plot(freq_spectrum,FR1_detrend,linestyle='dotted',label='Detrending')
axes[1].plot(freq_spectrum,FR1_detrend*FR1_smooth,label='window1')
axes[1].plot(freq_spectrum,FR2_detrend*FR2_smooth,label='window2')
axes[1].set_xlim(0,100)
axes[1].set_xlabel("Frequency")
axes[1].set_title('Zoomed in')
axes[0].legend()
